...
def get_dataloaders(data_dir, transforms, batch_size):
    train_data_set = WavImageDataset(data_dir=data_dir, csv_file="./data/train.csv", transforms=transforms)
    test_data_set = WavImageDataset(data_dir=data_dir, csv_file="./data/test.csv", transforms=transforms)
    val_data_set = WavImageDataset(data_dir=data_dir, csv_file="./data/val.csv", transforms=transforms)
