...
from dataset import WavImageDataset
...
class TrainClassifier:
    ...
    def init_datasets(self):
        ...
        self.train_data_set = WavImageDataset(data_dir=self.data_dir, csv_file="./data/train.csv", transforms=train_transforms)
        self.test_data_set = WavImageDataset(data_dir=self.data_dir, csv_file="./data/test.csv", transforms=train_transforms)
        self.val_data_set = WavImageDataset(data_dir=self.data_dir, csv_file="./data/val.csv", transforms=train_transforms)
